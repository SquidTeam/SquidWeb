...
public class Main {
  ...
  public static void main(String[] args) {
     ...
     * 
     * Connection connexion = null; String a = "a"; String b = "b";
     * 
     ...
     * 
     * System.out.println("Connexion ok !"); Statement statement = connexion.createStatement(); int
     * statut = statement.executeUpdate("INSERT INTO users(firstname) VALUES ('Benjamin')");
     * System.out.println(statut); } catch (SQLException e) {
     * 
